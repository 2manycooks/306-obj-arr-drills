...
let capitalizedEMI = album6.albumDetails.labels[1].toUpperCase()
album6.albumDetails.labels[1] = capitalizedEMI
...
let albumsLength = talkingHeadsAlbums.length
...
} else if(albumsLength % 3 === 0) {
  console.log(`The number ${albumsLength} is divisible by 3`)
} else {
  console.log(`The number ${albumsLength} is NOT divisible by 2 or 3.`)
}
